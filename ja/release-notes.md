...
## Notification > RCS Bizmessage > リリースノート { #notification-rcs-bizmessage-release-notes }

<a id="august-26-2025"></a>
### 2025. 08. 26. { #august-26-2025 }
<a id="august-26-2025-feature-updates"></a>
#### 機能改善
* [API/Console] 金融法令遵守告知フィールドを含むイメージテンプレートの対応
  * 金融法令遵守告知フィールドが含まれるイメージテンプレートの連携および送信をサポートします。
