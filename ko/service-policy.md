...
## Notification > RCS Bizmessage > 서비스 정책 { #notification-rcs-bizmessage-service-policy }
...
### 지원하는 발송 유형 { #supported-sending-type }
...
### 대체 발송 미지원 발송 유형 { #alternative-sending-unsupported-type }
- TEMPLATE: 이미지 템플릿
